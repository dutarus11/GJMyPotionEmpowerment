...
namespace SkyboxBlur
{
    public class SkyboxBlurEditor : ShaderGUI
    {
        ...
        static GUIContent _textCubemap = new GUIContent("Skybox");
        ...
        bool ShaderPropertiesGUI(MaterialEditor materialEditor)
        {
            ...
            materialEditor.ShaderProperty(_lod, "Blur?");
            if (_lod.hasMixedValue || _lod.floatValue > 0)
            {
                EditorGUI.indentLevel++;
                materialEditor.ShaderProperty(_lodLevel, "Blur Level");
                EditorGUI.indentLevel--;
            }
